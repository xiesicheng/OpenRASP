...
if test "$PHP_OPENRASP" != "no"; then
  ...
  case $host_os in
    darwin* )
      ...
      OPENRASP_LIBS="$OPENRASP_LIBS -LPREBUILTS_ROOT/lib64 -lv8_monolith -lcpr -lcurl"
      ;;
    * )
      ...
      OPENRASP_LIBS="$OPENRASP_LIBS -L$PREBUILTS_ROOT/lib64 -Wl,-Bstatic -lv8_monolith -lcpr -lcurl -lssl -lcrypto -lz -lc++ -lc++abi -Wl,-Bdynamic"
