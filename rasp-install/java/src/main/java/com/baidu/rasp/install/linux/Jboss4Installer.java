...
public class Jboss4Installer extends BaseStandardInstaller {
    ...
    private static String OPENRASP_CONFIG = "### BEGIN OPENRASP - DO NOT MODIFY ###\n" +
            ...
            "\tJAVA_OPTS=\"-javaagent:${JBOSS_HOME}/jacocoagent.jar=destfile=/home/travis/build/baidu/openrasp/agent/java/integration-test/jacoco/jacoco.exec,append=true -Xverify:none ${JAVA_OPTS}\"\n" +
            "### END OPENRASP ###\n";
