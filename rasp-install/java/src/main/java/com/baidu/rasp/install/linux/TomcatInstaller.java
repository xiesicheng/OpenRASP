...
public class TomcatInstaller extends BaseStandardInstaller {
    ...
    private static String JACOCO_CONFIG = "\tJAVA_OPTS=\"-javaagent:${CATALINA_HOME}/jacocoagent.jar=destfile=/home/travis/build/baidu/openrasp/jacoco.exec -Xverify:none ${JAVA_OPTS}\"\n";
