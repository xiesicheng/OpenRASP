...
public class TomcatInstaller extends BaseStandardInstaller {
    ...
    private static String JACOCO_CONFIG = "\tJAVA_OPTS=\"-javaagent:${CATALINA_HOME}/jacocoagent.jar=output=tcpserver,port=8899,address=10.20.4.10 -Xverify:none ${JAVA_OPTS}\"\n";
